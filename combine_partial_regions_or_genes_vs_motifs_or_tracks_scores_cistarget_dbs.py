...
def combine_partial_ct_scores_db_regions_or_genes_vs_motifs_or_tracks_cistarget_dbs(
    ...
    nbr_partial_dbs = len(partial_ct_scores_db_regions_or_genes_vs_motifs_or_tracks_vs_one_species_filenames)
    partial_db_type = DatabaseTypes.create_database_type_and_db_prefix_and_extension_from_db_filename(
        db_filename=partial_ct_scores_db_regions_or_genes_vs_motifs_or_tracks_vs_one_species_filenames[0]
    )[0]
    print(
        ...
        + '"\n  - "'.join(partial_ct_scores_db_regions_or_genes_vs_motifs_or_tracks_vs_one_species_filenames) + '"\n'
    )
    ...
    ct_scores_db_regions_or_genes_vs_motifs_or_tracks_filename = \
        ct_scores_db_regions_or_genes_vs_motifs_or_tracks.create_db_filename_from_db_prefix(
    ...
    elapsed_writing_regions_or_genes_vs_motifs_or_tracks_scores_db_time = (
            time.monotonic() - start_writing_regions_or_genes_vs_motifs_or_tracks_scores_db_time
    )
    print(
        f'Writing full cisTarget {ct_scores_db_regions_or_genes_vs_motifs_or_tracks.db_type.column_kind} vs '
...
def main():
    ...
    for partial_ct_scores_db_regions_or_genes_vs_motifs_or_tracks_filename in partial_ct_scores_db_regions_or_genes_vs_motifs_or_tracks_vs_filenames:
